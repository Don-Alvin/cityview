...
export const services: Service[] = [
  {
    ...
    metaTitle: "Commercial Printing | Business Cards & Brochures in Nairobi",
    metaDescription:
      "Business cards, flyers, brochures, booklets and office stationery, printed in Nairobi. Beautiful, useful print for the moments that put your business in front of people.",
    intro:
  ...
  },
  {
    ...
    metaDescription:
      "Shopfront signage, roll-up banners, vehicle branding and event displays in Nairobi. Give your business a visible, consistent presence, on the street or at your next event.",
    intro:
  ...
  },
  {
    ...
    metaTitle: "Apparel & Merchandise | Branded T-Shirts & Gifts in Nairobi",
    metaDescription:
      "Branded T-shirts, caps, tote bags, mugs and promotional gifts in Nairobi. Make your identity part of someone's day with useful branded items.",
    intro:
  ...
  },
  {
    ...
    metaTitle: "Custom Packaging | Branded Boxes & Bags in Nairobi",
    metaDescription:
      "Custom boxes, branded bags, product labels and packaging built around your product, printed in Nairobi. Every touchpoint carries the same identity.",
